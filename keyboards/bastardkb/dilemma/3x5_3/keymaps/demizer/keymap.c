...
#define LAYOUT_LAYER_BASE_DVORAK KC_LAYOUT_wrapper(               \
    SLSH, COMM,  DOT,    P, Y,  F,    G,    C,    R,    L, \
       A,    O,    E,    U, I,    D,    H,    T,    N,    S, \
       COLN,    Q,    J, K,    X,    B,    M,    W,    V,    Z, \
 ...
 *
 * This is meant to be used with `LAYOUT_LAYER_BASE_DVORAK` defined above, eg.:
 *
 *     HOME_ROW_MOD_GASC(LAYOUT_LAYER_BASE_DVORAK)
 */
 ...
 * This is meant to be used with `LAYOUT_LAYER_BASE_DVORAK` defined above, eg.:
 *
 *     MOUSE_MOD(LAYOUT_LAYER_BASE_DVORAK)
 */
#define _MOUSE_MOD(                                               \
    L00, L01, L02, L03, L04, R05, R06, R07, R08, R09,             \
    L10, L11, L12, L13, L14, R15, R16, R17, R18, R19,             \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_wrapper(
    MOUSE_MOD(HOME_ROW_MOD_GASC(LAYOUT_LAYER_BASE_DVORAK))
  ),
